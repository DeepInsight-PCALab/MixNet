...
import imagenet_dataloader as dataloader
...
parser.add_argument('--schedule', type=int, nargs='+', default=[30, 60, 90, 100],
...
def main():
    ...
    print('batch size:', args.train_batch)
    global best_acc
    ...
    train_loader = torch.utils.data.DataLoader(
        dataloader.ImageFolder(traindir, transforms.Compose([
    ...
    val_loader = torch.utils.data.DataLoader(
        dataloader.ImageFolder(valdir, transforms.Compose([
